    ...
    return (
        <>
            ...
            <div className="fixed bottom-28 right-0 z-50 flex flex-col items-end">
                ...
                <div className={`flex flex-col gap-2 mb-2 transition-all duration-400 ${isOpen ? 'opacity-100' : 'opacity-0 pointer-events-none'
                    }`}>
                    {/* Instagram Blob */}
                    <a
                ...
                <button
                    ...
                    className={`blob-main flex items-center justify-center w-14 h-14 shadow-xl transition-all duration-300 ${isOpen
                            ? 'bg-[#434343]'
